...
const WEAPONS_DATA: WeaponInfo[] = [
  {
    ...
    code: 'P-1 PEACEMAKER',
    description: 'Высокоточный револьвер с усиленным рикошетным патроном.',
    primaryName: 'Точный выстрел (12 патр.)',
    secondaryName: 'Рикошетный выстрел (КД 4 сек)',
    secondaryCd: 4,
  ...
  },
  {
    ...
    secondaryCd: 8,
    unlockedBy: 'Доступен на 4 уровне (Победа над Голиафом)',
    color: '#8B5CF6',
  },
  {
    id: 'punisher',
    name: 'Автомат «Каратель» (Калаш)',
    code: 'AR-47 PUNISHER',
    ...
    secondaryCd: 25,
    unlockedBy: 'Доступен на 8 уровне (Победа над Червём)',
    color: '#C41E3A',
  },
  {
    id: 'grapple',
    ...
    secondaryCd: 3,
    unlockedBy: 'Доступен по умолчанию (с пистолетом)',
    color: '#FFFFFF',
  },
];
